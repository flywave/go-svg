...
namespace svg
{
    ...
    rendering_interpreter::element_interpreters[end_of_elements] = {
        &agg::svg::rendering_interpreter::render_circle,
		&agg::svg::rendering_interpreter::render_clipPath,
        &agg::svg::rendering_interpreter::render_defs,    
        &agg::svg::rendering_interpreter::render_ellipse,
        &agg::svg::rendering_interpreter::render_g,
        &agg::svg::rendering_interpreter::render_line,
        &agg::svg::rendering_interpreter::render_linearGradient,
        &agg::svg::rendering_interpreter::render_path,
        &agg::svg::rendering_interpreter::render_polygon,
        &agg::svg::rendering_interpreter::render_polyline,
        &agg::svg::rendering_interpreter::render_radialGradient,
        &agg::svg::rendering_interpreter::render_rect,
        &agg::svg::rendering_interpreter::render_stop,
        &agg::svg::rendering_interpreter::render_svg,
        &agg::svg::rendering_interpreter::set_title_element,
        &agg::svg::rendering_interpreter::render_use,    
    };
    //-------------------------------------------------------------------------
